...
.Prerequisites
* A {uyuni} instance with a synchronized repository.
...
. Click *Software* to verify that {uyuni} created the `opensuse-leap-15-6-base-prod-openSUSE Leap 15.6 (x86_64)` channel.
+
.List of Available Channels
