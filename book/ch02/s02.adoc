...
This exercise synchronizes only the openSUSE Leap 15.6 repository required for the exercises in this book. Follow the documentation to https://www.uyuni-project.org/uyuni-docs/en/uyuni/client-configuration/clients-opensuseleap.html#_add_software_channels[synchronize the remaining channels and repositories] for a production deployment. Doing so requires around 250GB.
====
